  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 text-center relative z-10">
        ...
        <h1 className="font-['Orbitron'] text-4xl md:text-6xl font-bold mb-6 text-white max-w-5xl mx-auto leading-tight tracking-wider">
          The <span className="text-[#FFD43B]">simplest</span> way to organize your subscriptions and save money without effort
        </h1>
